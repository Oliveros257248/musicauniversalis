...
- **Chronos** (Χρόνος) — sequential time, the clock ticking
...
| Frequency | Name | How to reach |
|-----------|------|-------------|
| 19,378 kHz | Comma Gap · H₁ × δ | Browser — Twente WebSDR |
| 1,420,405 kHz | Hydrogen Line · H₁ | RTL-SDR $25 |
| **1,440,783 kHz** | **Comma Partner · H₁ × φ** | RTL-SDR $25 |
| 14,204 kHz | H₁ ÷ 100 | Browser |
...
| File | What it does |
|------|-------------|
| `index.html` | Front door — the comma, the frequencies, the crew call |
| `musica_universalis_v5.html` | Full theory — 13 interactive sections |
...
| `orpheus_calling.html` | The crew recruitment transmission |
...
| `listen_to_the_cosmos.html` | Build your own receiver for $25 |
| `solar_v4_explorer.html` | Interactive solar system — orbital resonances live |
...
- **The Astronomer** — orbital resonances, pulsar timing, WR 104
- **The Signal Analyst** — Wow! Signal, comma-transform, SDR hardware
- **The Chemist** — cyanine extension, NIST data, Cy9/Cy11
- **The Mathematician** — formal proof, Diophantine approximation, δ structure
- **The Biologist** — circadian period, Krebs cycle, free-running rhythms
- **The Engineer** — receiving station, antenna design, hardware
